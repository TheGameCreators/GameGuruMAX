...
-- DESCRIPTION: [PROMPT_TEXT$="What the hell"], [ACTIVATION_RANGE=100(1,1000)], [@GROW_MODE=1(1=XYZ All, 2=X Only, 3=Y Only, 4=Z Only)],[GROW_SPEED#=0.10(0.0,1.0)],[GROW_SCALE#=5.0(0.0,100.0)]
