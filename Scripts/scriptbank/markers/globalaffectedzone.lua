...
function GlobalAffectedZone_properties(e, prompt_text, effect, amount, seconds, user_global_affected, health_affected, ZoneHeight, SpawnAtStart)
	gazone[e] = g_Entity[e]
...
function GlobalAffectedZone_init(e)
	gazone[e] = {}
...
function GlobalAffectedZone_main(e)	
	gazone[e] = g_Entity[e]
