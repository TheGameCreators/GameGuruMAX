-- DESCRIPTION: This will control a character using <Soldier Animations> to engage their enemy within view, can also [!FollowAPath=1] at the start,and is capable of attacking their target using a <Shooting Weapon> and [!CanRetreat=1] to the [RetreatRange=500(200,1000)] when hurt. Sound effects are alerted in <Sound0>, seen target in <Sound1>, lost target in <Sound2> and killed target in <Sound3>. Have this character [!StandGround=0] to defend their position, and when not using a [!RandomFlankMode=1], can optionally [@FlankTarget=1(1=Stay Back, 2=Get Close, 3=Wide Flank, 4=Use Cover)], start [!Alerted=0], [AllowHeadshot!=1], [*CombatTime=15000] and [!CanHearSound=1] within [HearingRange=1250]. Optionally [!StarterAnimation=0] using [@StartAnimation=1(0=AnimSetList)].
