...
-- NPC Monitor v8 by Necrym59
-- DESCRIPTION: A global behavior that allows a named npc to be health monitored and trigger event(s) or Lose Game or Win game upon death.
...
function npc_monitor_properties(e, npc_name, death_action, display_health, monitor_active, action_delay, user_global, user_global_value)
