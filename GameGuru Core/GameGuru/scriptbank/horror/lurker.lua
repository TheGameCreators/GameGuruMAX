...
-- DESCRIPTION: [@MODE=1(1=Follow only, 2=Attack in range)]
...
function lurker_properties(e, reaction_text, sense_range, sense_angle, approach_speed, rotation_speed, mode, attack_range, attack_delay, attack_damage, transparency, emissiveness)
	lurker[e] = g_Entity[e]
