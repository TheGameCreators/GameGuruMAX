	...
	if (  t.tokay == 1 ) 
	{
		...
		for ( t.slidersmenuindex = 1 ; t.slidersmenuindex<=  g.slidersmenumax; t.slidersmenuindex++ )
		{
			...
			if ( t.tabviewflag == 1 ) 
			{
				...
				{
					// Old hard-coded health/ammo HUD
					...
					//			t.tDiffuseB = 0;
					//		}
					//		SetSpriteDiffuse (  g.ammopanelsprite,t.tDiffuseR,t.tDiffuseG, t.tDiffuseB);
					...
					//	t.tDiffuseR = 0; t.tDiffuseG = 0; t.tDiffuseB = 0;
					...
					//	// handle immunity display
					//	if (t.huddamage.immunity > 0)
					//	{
					//		t.tDiffuseR = 0;
					//		t.tDiffuseG = 50 + ((1 + Cos(Timer() / 1.5)) * 100);
					//		t.tDiffuseB = t.tDiffuseG / 2;
					//	}

					//	SetSpriteDiffuse (  g.healthpanelsprite,t.tDiffuseR,t.tDiffuseG, t.tDiffuseB);
