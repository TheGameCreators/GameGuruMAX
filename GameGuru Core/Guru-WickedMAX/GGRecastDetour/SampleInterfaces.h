...
/// MAX debug draw implementation.
struct sDebugObjectVert
{
	float x, y, z;
	unsigned int color;
};
class DebugDrawMAX : public duDebugDraw
{
public:
	...
	virtual void vertex_raised(const float* pos, unsigned int color, float fRaiseY);
...
protected:
	int m_iDebugObject;
	int m_iDebugObjectType;
	std::vector<sDebugObjectVert> m_DebugObjectVertList;
	bool m_bDebugObjectRefreshed[100];
};
