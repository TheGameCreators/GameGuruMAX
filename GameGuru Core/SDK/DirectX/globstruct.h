...
// allow VR QUEST to render in SRGB format for Oculus Link
#ifdef VRTECH
#define DXGIFORMATR8G8B8A8UNORM DXGI_FORMAT_R8G8B8A8_UNORM //DXGI_FORMAT_R8G8B8A8_UNORM_SRGB first attemt failed - 2022 now!
#else
#define DXGIFORMATR8G8B8A8UNORM DXGI_FORMAT_R8G8B8A8_UNORM
#endif
