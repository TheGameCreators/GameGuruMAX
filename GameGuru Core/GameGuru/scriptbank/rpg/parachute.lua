...
-- Parachute v6 by Necrym59 (from an idea created by cybernescence)

-- DESCRIPTION: Attached to the parachute object. Physics Off, Collision = None, Gravity Off, Weight and Friction 0ff.
...
-- DESCRIPTION: <Sound0> Flying Sound
...
function parachute_main(e)
	...
	elseif state[e] == "parachuting" then 	
		new_y = math.rad(g_Entity[e]['angley'])
		pos_x = g_Entity[e]['x'] + (math.sin(new_y) * parachute[e].mount_z_adjustment)
		pos_z = g_Entity[e]['z'] + (math.cos(new_y) * parachute[e].mount_z_adjustment)
		...
		pos_y = GetTerrainHeight(pos_x,pos_z)		
		SetPosition(e,pos_x,pos_y,pos_z)		
