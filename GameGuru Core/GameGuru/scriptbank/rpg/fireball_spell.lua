...
function fireball_spell_properties(e, prompt_text, useage_text, pickup_range, user_global_affected, mana_cost, cast_damage, cast_radius, particle1_name, particle2_name)
...
function fireball_spell_main(e)
	...
	if status[e] == "collect_spell" then
		...
		if LookingAt == 1 and PlayerDist < fireball_spell[e].pickup_range then
