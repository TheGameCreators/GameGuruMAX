...
#ifdef WICKEDENGINE
LPVOID					GGVR_LEyeImage_Res;
LPVOID					GGVR_REyeImage_Res;
LPVOID					GGVR_Skybox_Res[6];
LPVOID					GGVR_LEyeImage;
LPVOID					GGVR_REyeImage;
LPVOID					GGVR_Skybox[6];
#else
...
#ifdef WICKEDENGINE
float							GGVR_FarClip = DEFAULT_FAR_PLANE;
#else
float							GGVR_FarClip = 70000;
#endif
	...
	if ( GGVR_TeleportState != GGVR_TELEPORT_INACTIVE )
	{
		...
		for ( int o = GGVR_Player.ObjTeleportStart; o < GGVR_Player.ObjTeleportFinish; o++ )
		{
			...
			else
			{
				...
				#ifdef WICKEDENGINE
				// keep applying this after resetting texture (above)
		...
		#ifdef WICKEDENGINE
		// keep applying this after resetting texture (above)
		SetObjectTransparency ( GGVR_Player.ObjTeleportFinish, 1 );
		SetAlphaMappingOn ( GGVR_Player.ObjTeleportFinish, 50 );
		#endif
