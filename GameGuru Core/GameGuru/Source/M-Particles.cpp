...
void ravey_particles_hide_all_particles(void)
{
	int maxIterator = g.raveyparticlesobjectoffset + RAVEY_PARTICLES_MAX;

	for (int obj = g.raveyparticlesobjectoffset; obj < maxIterator; obj++)
	{	
		HideObject(obj);
	}
