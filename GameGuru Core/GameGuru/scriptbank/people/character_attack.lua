...
function character_attack_main(e)
 if g_character_attack[e] ~= nil and g_character_attack_behavior_count > 0 then
  g_character_attack_behavior_count = master_interpreter_core.masterinterpreter (g_character_attack_behavior, g_character_attack_behavior_count, e, g_character_attack[e], g_Entity[e])
 end
