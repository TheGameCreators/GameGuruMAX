...
-- Clone_Entity v15 by Necrym59 and Lee
...
-- DESCRIPTION: [ENTITY_NO=0(0,1000)]
-- DESCRIPTION: [DIAGNOSTICS=0(0,1000)]
...
function clone_entity_properties(e, clone_quantity, clone_range, clone_lifespan, entity_name, entity_no, diagnostics, clone_health, respawn_cycle, respawn_events, respawn_interval)
	...
	clone_entity[e].diagnostics = diagnostics or 0
end
