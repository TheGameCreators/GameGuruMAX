...
function zombie_attack_properties(e, range, maximumrange, minspeed, maxspeed, feeding, chasemodes, recoverytime, canhearsound, hearingrange, getbackup, allowheadshot)
 ...
 g_zombie_attack[e]['getbackup'] = getbackup 
...
function zombie_attack_main(e)
 if g_zombie_attack[e] ~= nil and g_zombie_attack_behavior_count > 0 then
  g_zombie_attack_behavior_count = master_interpreter_core.masterinterpreter (g_zombie_attack_behavior, g_zombie_attack_behavior_count, e, g_zombie_attack[e], g_Entity[e])
 end
end
