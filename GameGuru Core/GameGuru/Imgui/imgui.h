...
enum ImGuiWindowFlags_
{
	...
	ImGuiWindowFlags_ForceRender			= 1 << 30,  // Force render id we are digging a hole in all windows.
	ImGuiWindowFlags_NoChangeZOrder			= 1 << 31	// Do not change z order when focus window.
    // [Obsolete]
