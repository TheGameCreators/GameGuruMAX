...
function spin_main(e)
	...
	if g_spin[e]['x_axis'] == 1 then RotateX(e,GetAnimationSpeed(e)*tspinspeed) end
	if g_spin[e]['y_axis'] == 1 then RotateY(e,GetAnimationSpeed(e)*tspinspeed) end
	if g_spin[e]['z_axis'] == 1 then RotateZ(e,GetAnimationSpeed(e)*tspinspeed) end
end
