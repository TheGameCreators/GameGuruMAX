...
-- Global Activator v3  by Necrym59
...
function global_activator_properties(e, activation_style, activation_range, user_global, trigger_value, trigger_delay, visibility)
