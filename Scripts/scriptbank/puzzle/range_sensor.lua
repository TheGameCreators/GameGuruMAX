-- Range Sensor v6 by Necrym59
-- DESCRIPTION: The attached object will be a range sense to detect player for activating other linked objects or game elements. Set Always Active = On
