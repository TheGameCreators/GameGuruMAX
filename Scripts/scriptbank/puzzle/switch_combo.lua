-- Switch Combo v5 
-- DESCRIPTION: A combo-value switch to add to 100 to Activate If Used object.
-- DESCRIPTION: [UseRange=90(1,200)]
-- DESCRIPTION: [SwitchedOn!=1] state to decide if the switch is initially off or on, and customize the
...
-- DESCRIPTION: [SwitchValue=0(0,100)] 
...
function switch_combo_properties(e, userange, switchedon, ontext, offtext, playerlevel, switchtype, switchvalue)
