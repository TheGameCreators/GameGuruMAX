...
function recipe_properties(e, pickup_text, collected_text, quantity, pickup_range, pickup_style, prompt_display, item_highlight)
...
function recipe_main(e)
	...
	if recipe[e].pickup_style == 2 and PlayerDist < recipe[e].pickup_range then
		...
		module_misclib.pinpoint(e,recipe[e].pickup_range,recipe[e].item_highlight)
		tEnt[e] = g_tEnt
