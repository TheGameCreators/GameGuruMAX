-- Trapdoor v4 - thanks to Necrym59
-- DESCRIPTION: Can be used on rotated existing doors. Apply floor texture to disguise if required.
-- DESCRIPTION: When the player is within [RANGE=60(30,100)] open the trapdoor after [OPEN_DELAY=0(0,20)] and play <Sound0> and close after [CLOSE_DELAY=3(1,20)] and <Sound1> is played. Change the trapdoor [@VISIBILITY=1(1=Visible, 2=Invisible)]
...
function trapdoor_main(e)
	...
	SetActivated(e,1)
	ontrapdoor[e]=IntersectAll(g_PlayerPosX,g_PlayerPosY+35,g_PlayerPosZ,g_Entity[e]['x'],36,g_Entity[e]['z'],0)
	if ontrapdoor[e] > 0 then ontrapdoor[e] = 1 else ontrapdoor[e] = 0 end	
