...
function resource_properties(e, pickup_text, collected_text, quantity, pickup_range, pickup_style, prompt_display, item_highlight)
...
function resource_main(e)
	...
	if resource[e].pickup_style == 2 and PlayerDist < resource[e].pickup_range then
		...
		module_misclib.pinpoint(e,resource[e].pickup_range,resource[e].item_highlight)
		tEnt[e] = g_tEnt
