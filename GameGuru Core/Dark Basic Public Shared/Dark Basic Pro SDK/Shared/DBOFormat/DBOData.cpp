...
sAnimation::sAnimation ( )
{
	...
	#ifdef WICKEDENGINE
	wickedanimationchannel[0] = -1;
	wickedanimationchannel[1] = -1;
	wickedanimationchannel[2] = -1;
	wickedanimationsampler[0] = -1;
	wickedanimationsampler[1] = -1;
	wickedanimationsampler[2] = -1;
	#endif
}
...
sObject::sObject ( )
{
	...
	// Wicked ref resets
	#ifdef WICKEDENGINE
	wickedrootentityindex		= 0;
	wickedloaderstateptr		= NULL;
	bUseFixedSize				= false;
	vecFixedSize				= { 1.0,1.0,1.0 };
