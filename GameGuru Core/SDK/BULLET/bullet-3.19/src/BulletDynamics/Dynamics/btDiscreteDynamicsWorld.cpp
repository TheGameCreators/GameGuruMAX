...
int btDiscreteDynamicsWorld::stepSimulation(btScalar timeStep, int maxSubSteps, btScalar fixedTimeStep)
{
	...
	if (maxSubSteps)
	{
		...
		//}
		#else
		//PE: Wicked terrain generate more iTotalPenetrationRecoveryAttempts.
		//static int iTotalPenetrationRecoveryAttemptsLargers = 0;
		//static int numSimulationSubStepsLargest = 0;
		//if (numSimulationSubSteps > numSimulationSubStepsLargest) numSimulationSubStepsLargest = numSimulationSubSteps;
		//if (iTotalPenetrationRecoveryAttempts > iTotalPenetrationRecoveryAttemptsLargers) iTotalPenetrationRecoveryAttemptsLargers = iTotalPenetrationRecoveryAttempts;
		//PE: In wicked lowest timeavg is 0.05
		if (timeavg > 0.045 ) //PE: < 20 fps before reducing physics.
		{
			//PE: Move the physics world at twice the speed. (fixedTimeStep) to get out of Recovery Attempts faster.
			fixedTimeStep = (1.0f / 60.0f);
		}
		#endif
	...
	if (numSimulationSubSteps)
	{
		...
		//PE: aded this at some previous point, no doc
