...
-- Light Control v17 by Necrym59, with thanks to synchromesh
...
-- DESCRIPTION: [#SPEED=1.20(0.0,10.0)]
-- DESCRIPTION: [@MODE=1(1=Turn Off, 2=Minimum , 3=Keep On, 4=Change Color)]
...
function lightcontrol_main(e)
	...
	if g_Entity[e]['activated'] == 1 then
		...
		if current_level[e] < lightcontrol[e].max_light_distance then			
			...
			if lightcontrol[e].light_object_no > 0 then SetEntityEmissiveStrength(lightcontrol[e].light_object_no,current_level[e]*5) end
