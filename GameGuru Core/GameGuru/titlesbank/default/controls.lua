...
function controls_init()
 ...
 if GetStoryboardActive("controls.lua") == 0 then -- old way, if not using storyboard
...
function controls_main()
 ...
 g_posAboutBackdropAngle = g_posAboutBackdropAngle + 0.002
   ...
   DisplayScreen("controls.lua")  -- display storyboard screen.
 end
end

function controls_free()
 if GetStoryboardActive("controls.lua") == 0 then -- old way, if not using storyboard
 -- free resources
